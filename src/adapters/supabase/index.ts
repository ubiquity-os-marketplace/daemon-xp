...
import { IssueLocationInput, SaveXpRecordInput, UserXpScopeOptions } from "../../types/supabase";
...
export class SupabaseAdapter {
  ...
  readonly xp = {
    ...
    getUserTotal: (userId: number, options?: UserXpScopeOptions) => fetchUserTotal(this._context.logger, this._client, userId, options),
  };
}
